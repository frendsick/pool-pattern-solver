...
- Integration shape: a fixture script (like the existing repro/sweep
  scripts, but in Python) that replays planned shots with the cue position, ghost
  ball, shot type mapped to spin state, and travel mapped to impact speed, then
