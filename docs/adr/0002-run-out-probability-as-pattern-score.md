...
- One deliberate impurity: near-tied patterns are ranked with a tiny complexity discount (shot type, rails, travel — "keep it simple", Dr. Dave #1), because easy layouts saturate every option near 100% and pure probability cannot break the tie. The discount affects ranking only; the reported Run-out Probability stays pure.
